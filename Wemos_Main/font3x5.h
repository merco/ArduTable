...
const unsigned char PROGMEM font3x5[] = 
{
...
0x17, 0x15, 0x1F,0x00, // 9
  0x00,0x18,0x18,0x00, // : to do
0x00,0x18,0x18,0x00, // ; to do
0x06,0x0C,0x18,0x00, // < to do
0x00,0x00,0x7E,0x00, // = to do
0x60,0x30,0x18,0x00, // > to do
0x7C,0xC6,0x0C,0x00, // ? to do
0x7C,0xC6,0xDE,0x00, // @ to do
0x1F, 0x05, 0x1F,0x00, // A
0x1F, 0x15, 0x1B,0x00, 
0x1F, 0x11, 0x11,0x00, 
0x1F, 0x11, 0x0E,0x00, 
0x1F, 0x15, 0x11,0x00, 
...
0x3C,0x30,0x30,0x00, // [  to do
0xC0,0x60,0x30,0x00, // <Backslash>  to do 
0x3C,0x0C,0x0C,0x00, // ]  to do
0x10,0x38,0x6C,0x00, // ^  to do
0x00,0x00,0x00,0x00, // _   to do
0x30,0x18,0x0C,0x00, // '  to do
...
0x1A, 0x04, 0x1A,0x00, 
0x2E, 0x28, 0x1E, 0x00,
0x1A, 0x12, 0x16,0x00, // z
0x0E,0x18,0x18,0x00, // { to do
0x18,0x18,0x18,0x00, // | to do 
0x70,0x18,0x18,0x00, // } to do
0x76,0xDC,0x00,0x00, // ~ to do
};
